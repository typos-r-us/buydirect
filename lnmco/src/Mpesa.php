...
*/
   ...
   class Mpesa
  {
      ...
      function __construct() { 
        ...
        $this->consumer_key       = 'PW3vWUP4Yr5nfLDGDii4laZGTEnKax3p';
        $this->consumer_secret    = 'yMTKele5MHIRnMhZ';
        $this->shortcode          = '174379';
        $this->shortcode1         = '603021';
        $this->shortcode2         = '600000';
        $this->initiatorName      = 'apipop37';
        $this->initiatorPass      = 'Safaricom3021#';
        $this->confirmation_url   = 'https://buydirect.palacina.com/lmnco/confirmation_url.php';
        $this->validation_url     = 'https://buydirect.palacina.com/lmnco/validation_url.php';
        $this->callback_url       = 'https://buydirect.palacina.com/lmnco/callback_url.php';
        $this->result_url         = 'https://buydirect.palacina.com/lmnco/result_url.php';
        $this->timeout_url        = 'https://buydirect.palacina.com/lmnco/timeout_url.php';
